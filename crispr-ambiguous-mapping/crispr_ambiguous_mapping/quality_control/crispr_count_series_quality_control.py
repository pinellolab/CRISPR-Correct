...
def log_count_series_warnings(match_type_string: str,
         ...
         protospacer_match_gt_given_match_type_total: Optional[int] = None,
         given_match_type_vs_protospacer_match_total_ratio: Optional[float] = None,
         given_match_type_vs_protospacer_match_total_ratio_threshold: Optional[float] = None,
         umidups_mean: Optional[float] = None,
         umidups_lower_threshold: Optional[float] = None,
         umidups_upper_threshold: Optional[float] = None):
    ...
    if protospacer_match_gt_given_match_type_total is not None:
        ...
        if protospacer_match_gt_given_match_type_total < total_count:
            print(f"WARNING for {match_type_string}; {count_type_string}: There are {total_count-protospacer_match_gt_given_match_type_total} unexpected sequences greater than the protospacer-match out of {total_count} guides. This may be due to the match type having improved mapping performance, though these sequences many be worth investigating manually.")
    ...
    if zerocount > 0: 
        ...
        print(f"WARNING for {match_type_string}; {count_type_string}: There are {zerocount} guides with count of 0 out of {total_count} total guides. This may be due to low coverage or a mapping issue. Recommended to investigate coverage issue or investigate these sequences manually for mapping issues, especially if recurrent across different samples (especially high-coverage plasmid samples).")
    ...
    if (umidups_mean is not None) and (umidups_lower_threshold is not None):
        ...
        if umidups_mean <= umidups_lower_threshold:
    ...
    if (umidups_mean is not None) and (umidups_upper_threshold is not None):
        ...
        if umidups_mean >= umidups_upper_threshold:
...
def count_series_result_quality_control_stats(count_series_result: MatchSetWhitelistReporterCounterSeriesResults,
    ...
    if contains_guide_umi:
        ...
        protospacer_match_collapsed_coverage_lower_quantile = count_series_result.protospacer_match.ambiguous_accepted_umi_collapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
        ...
        protospacer_match_noncollapsed_coverage_lower_quantile = count_series_result.protospacer_match.ambiguous_accepted_umi_noncollapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
        ...
        if contains_surrogate:
                ...
                protospacer_surrogate_match_collapsed_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match.ambiguous_accepted_umi_collapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                ...
                if display_visualizations:
                    ...
                    log_count_series_warnings(match_type_string="protospacer+surrogate-match",
                                      count_type_string="UMI-collapsed",
                                      total_count=protospacer_surrogate_match_collapsed_totalcount,
                ...
                protospacer_surrogate_match_noncollapsed_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match.ambiguous_accepted_umi_noncollapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                ...
                if display_visualizations:
                    ...
                    log_count_series_warnings(match_type_string="protospacer+surrogate-match",
                                      count_type_string="UMI-noncollapsed",
                                      total_count=protospacer_surrogate_match_noncollapsed_totalcount,
                ...
                if contains_guide_barcode:
                        ...
                        protospacer_surrogate_barcode_match_collapsed_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match_barcode_match.ambiguous_accepted_umi_collapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                        ...
                        if display_visualizations:
                            ...
                            log_count_series_warnings(match_type_string="protospacer+surrogate+barcode-match",
                                            count_type_string="UMI-collapsed",
                                            total_count=protospacer_surrogate_barcode_match_collapsed_totalcount,
                        ...
                        protospacer_surrogate_barcode_match_noncollapsed_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match_barcode_match.ambiguous_accepted_umi_noncollapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                        ...
                        if display_visualizations:
                            ...
                            log_count_series_warnings(match_type_string="protospacer+surrogate+barcode-match",
                                            count_type_string="UMI-noncollapsed",
                                            total_count=protospacer_surrogate_barcode_match_noncollapsed_totalcount,
                                            protospacer_match_gt_given_match_type_total=protospacer_match_gt_protospacer_surrogate_barcode_match_noncollapsed_total,
                                            given_match_type_vs_protospacer_match_total_ratio=protospacer_surrogate_barcode_match_vs_protospacer_match_noncollapsed_total_ratio_threshold,
                                            given_match_type_vs_protospacer_match_total_ratio_threshold=given_match_type_vs_protospacer_match_total_ratio_threshold,
            ...
            if contains_guide_barcode:
                    ...
                    protospacer_barcode_match_collapsed_coverage_lower_quantile = count_series_result.protospacer_match_barcode_match.ambiguous_accepted_umi_collapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                    ...
                    if display_visualizations:
                        ...
                        log_count_series_warnings(match_type_string="protospacer+barcode-match",
                                        count_type_string="UMI-collapsed",
                                        total_count=protospacer_barcode_match_collapsed_totalcount,
                    ...
                    protospacer_barcode_match_noncollapsed_coverage_lower_quantile = count_series_result.protospacer_match_barcode_match.ambiguous_accepted_umi_noncollapsed_counterseries.quantile(q=lower_quantile_coverage_percentage)
                    ...
                    if display_visualizations:
                        ...
                        log_count_series_warnings(match_type_string="protospacer+barcode-match",
                                        count_type_string="UMI-collapsed",
                                        total_count=protospacer_barcode_match_noncollapsed_totalcount,
        ...
        protospacer_match_noumi_coverage_lower_quantile = count_series_result.protospacer_match.ambiguous_accepted_counterseries.quantile(q=lower_quantile_coverage_percentage)
        ...
        if contains_surrogate:
            ...
            protospacer_surrogate_match_noumi_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match.ambiguous_accepted_counterseries.quantile(q=lower_quantile_coverage_percentage)
            ...
            if display_visualizations:
                ...
                log_count_series_warnings(match_type_string="protospacer+surrogate-match",
                                count_type_string="No-UMI",
                                total_count=protospacer_surrogate_match_noumi_totalcount,
            ...
            if contains_guide_barcode:
                ...
                protospacer_surrogate_barcode_match_noumi_coverage_lower_quantile = count_series_result.protospacer_match_surrogate_match_barcode_match.ambiguous_accepted_counterseries.quantile(q=lower_quantile_coverage_percentage)
                ...
                if display_visualizations:
                    ...
                    log_count_series_warnings(match_type_string="protospacer+surrogate+barcode-match",
                                    count_type_string="No-UMI",
                                    total_count=protospacer_surrogate_barcode_match_noumi_totalcount,
            ...
            if contains_guide_barcode:
                ...
                protospacer_barcode_match_noumi_coverage_lower_quantile = count_series_result.protospacer_match_barcode_match.ambiguous_accepted_counterseries.quantile(q=lower_quantile_coverage_percentage)
                ...
                if display_visualizations:
                    ...
                    log_count_series_warnings(match_type_string="protospacer+barcode-match",
                                    count_type_string="No-UMI",
                                    total_count=protospacer_barcode_match_noumi_totalcount,
...
def plot_match_type_comparisons(all_count_series_result: AllMatchSetWhitelistReporterCounterSeriesResults, contains_guide_umi: bool, contains_surrogate: bool, contains_guide_barcode: bool, collapsed:bool=False, alpha: float=0.3):
    if contains_guide_umi:
        if contains_surrogate:
            if collapsed:
                # PROTOSPACER+SURROGATE vs. PROTOSPACER - COLLAPSED
